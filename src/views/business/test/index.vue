    ...
    <el-row :gutter="20">
      ...
      <el-col :span="4" :xs="24">
        <div class="head-container">
          <el-input v-model="nickName" placeholder="请输入会员昵称" clearable size="small" prefix-icon="el-icon-search"
            style="margin-bottom: 20px" />
        </div>
        <!-- 树形结构数据 -->
        <div class="head-container">
          <el-tree :data="userOptions" :props="defaultProps" :expand-on-click-node="false"
